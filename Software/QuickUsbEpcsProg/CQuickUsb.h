...
public:
    ...
    QRETURN WriteDataAsync(PQBYTE data, QULONG length, PQBYTE transaction);    // Deprecated
    QRETURN ReadDataAsync(PQBYTE data, PQULONG length, PQBYTE transaction);    // Deprecated
    QRETURN AsyncWait(PQULONG bytecount, QBYTE transaction, QBYTE immediate);  // Deprecated
    ...
    QRETURN BulkWait(PQBULKSTREAM bulkStream);

    ///////////////////
    // Streaming API //
    ///////////////////
    QRETURN ReadBulkDataStartStream(PQBYTE buffers[], QULONG numBuffers, QULONG bufferSize, PQBULKSTREAM_COMPLETION_ROUTINE cRoutine, PQVOID tag);
    QRETURN WriteBulkDataStartStream(PQBYTE buffers[], QULONG numBuffers, QULONG bufferSize, PQBULKSTREAM_COMPLETION_ROUTINE cRoutine, PQVOID tag);
    QRETURN BulkDataStopStream(QBOOL wait);
    ...
    // EPCS API //
    //////////////
    QRETURN IdentifyEpcs(QBYTE nSS, PQWORD epcsId, PQULONG epcsByteSize, ULONG flags);
