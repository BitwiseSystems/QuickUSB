...
Private Sub UserControl_Resize()
   ...
   BitCheckBox(7).Left = 10
   For count = 0 To 6
      BitCheckBox(6 - count).Left = BitCheckBox(7 - count).Left + BitCheckBox(7 - count).Width + 10
   Next
   ValueTextBox.Left = BitCheckBox(0).Left + BitCheckBox(0).Width + 10
End Sub
