...
// Memory File API //
/////////////////////
QRETURN CQuickUsb::OpenMemoryFile(PCQCHAR path, QULONG length, PQMEMFILEHANDLE hFile, PQBYTE *memory, QULONG flags) {
    if (QuickUsbOpenMemoryFile(path, length, hFile, memory, flags) == 0) {
        return false;
    }
...
QRETURN CQuickUsb::CloseMemoryFile(PQMEMFILEHANDLE hFile, PQBYTE *memory, QULONG length, QULONG flags) {
    if (QuickUsbCloseMemoryFile(hFile, memory, length, flags) == 0) {
        return false;
    }
