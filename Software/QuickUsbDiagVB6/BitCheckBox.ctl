...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
   ...
   BitCheckBox(0).ToolTipText = PropBag.ReadProperty("ToolTipTextBit0", m_def_ToolTipTextBit0)
   m_ToolTipTextBit0 = BitCheckBox(0).ToolTipText
   
   BitCheckBox(1).ToolTipText = PropBag.ReadProperty("ToolTipTextBit1", m_def_ToolTipTextBit1)
   m_ToolTipTextBit1 = BitCheckBox(1).ToolTipText
   
   BitCheckBox(2).ToolTipText = PropBag.ReadProperty("ToolTipTextBit2", m_def_ToolTipTextBit2)
   m_ToolTipTextBit2 = BitCheckBox(2).ToolTipText
   
   BitCheckBox(3).ToolTipText = PropBag.ReadProperty("ToolTipTextBit3", m_def_ToolTipTextBit3)
   m_ToolTipTextBit3 = BitCheckBox(3).ToolTipText
   
   BitCheckBox(4).ToolTipText = PropBag.ReadProperty("ToolTipTextBit4", m_def_ToolTipTextBit4)
   m_ToolTipTextBit4 = BitCheckBox(4).ToolTipText
   
   BitCheckBox(5).ToolTipText = PropBag.ReadProperty("ToolTipTextBit5", m_def_ToolTipTextBit5)
   m_ToolTipTextBit5 = BitCheckBox(5).ToolTipText
   
   BitCheckBox(6).ToolTipText = PropBag.ReadProperty("ToolTipTextBit6", m_def_ToolTipTextBit6)
   m_ToolTipTextBit6 = BitCheckBox(6).ToolTipText
   
   BitCheckBox(7).ToolTipText = PropBag.ReadProperty("ToolTipTextBit7", m_def_ToolTipTextBit7)
   m_ToolTipTextBit7 = BitCheckBox(7).ToolTipText
