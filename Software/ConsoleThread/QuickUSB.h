...
// 
// *****************  Version 2  *****************
// User: Jay Towson   Date: 5/26/04    Time: 10:15a
// Updated in $/Projects/Bitwise/QuickUSB/Software/ConsoleThread
// 
// *****************  Version 18  *****************
// User: Jay Towson   Date: 5/26/04    Time: 10:10a
// Updated in $/Projects/Bitwise/QuickUSB/Software/QuickUsb
// Added Sleep(0) to make sure other threads run between read/write and
// Wait functions
// 
// *****************  Version 1  *****************
// User: Blake Henry  Date: 5/21/04    Time: 8:36a
// Created in $/Projects/Bitwise/QuickUSB/Software/ConsoleThread
// 
// *****************  Version 1  *****************
...
extern int WINAPI QuickUsbOpen(HANDLE *hDevice, char *deviceName);
...
////////////////////////TEST CODE///////////////////////////
extern int WINAPI QuickUsbWriteDataAsync(HANDLE hDevice, unsigned char *data, 
                             unsigned long length, unsigned char *transaction);

extern int WINAPI QuickUsbReadDataAsync(HANDLE hDevice, unsigned char *data, 
                             unsigned long *length, unsigned char *transaction);

extern int WINAPI QuickUsbAsyncWait(HANDLE hDevice, unsigned long *bytecount,
