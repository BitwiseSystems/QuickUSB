...
int CQuickUsb::SetLastErrorString(char *errorStr) {
   strcpy(lastErrorString, errorStr);
   return TRUE;
}
...
int CQuickUsb::UploadFpga(char *filename)
{
   unsigned short isConfigured;
   int blockLength = 64, fileSize = 0, index;
